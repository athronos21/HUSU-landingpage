  ...
  return (
    <div className="coming-soon-page">
      <div className="cs-content">
        ...
        <span className="cs-label">Events & Activities</span>
        <h1>Coming Soon</h1>
        <p>We're preparing our events calendar. Upcoming events, activities, and programs organized by HUSU will be posted here and on our Telegram channel.</p>
        <a
